...
const Exp = () => {
  return (
    <div className="mt-10 mb-16">
      {/* Section Title */}
      <h2 className="text-2xl group font-semibold mb-6 flex items-center gap-2">
        <span className="group-hover:opacity-100 opacity-0 text-2xl font-bold">#</span>
        Experience
      </h2>

      <div className="border-l-2 border-neutral-300 dark:border-neutral-700 pl-5 ml-2 space-y-3">
        ...
        <div className="flex items-start w-full">
          ...
          <div className="ml-3 w-full">
            ...
            {/* Title row — COMPANY NAME as title */}
            <div className="flex justify-between w-full items-center">
              ...
              <div className="flex items-center gap-3 text-xl font-bold">
                ...
                {/* Tooltip with dot + icon */}
                <Tooltip>
                  <TooltipTrigger>
                    <div className="flex items-center gap-2 cursor-pointer border px-3 py-1 text-sm rounded-full hover:bg-neutral-100 dark:hover:bg-neutral-800 transition">
                      {/* Ping dot */}
            ...
            {/* Post / Position */}
            <p className="mt-1 text-neutral-700 dark:text-neutral-500 text-lg font-medium">
            ...
            <div className="flex flex-wrap items-center gap-3 mt-3 text-neutral-700 dark:text-neutral-300">
              ...
              {/* HTML */}
              <span className="flex items-center gap-2 border-dashed border-2 px-3 py-1 text-sm rounded-xl 
              hover:scale-105 transition-all cursor-pointer hover:bg-primary/5">
              ...
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  <ul className="ml-5 mt-1 list-disc text-neutral-700 dark:text-neutral-300 space-y-1">
                    <li>
                      Built and maintained the official dairy website using 
